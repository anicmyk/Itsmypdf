  ...
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        ...
        'tool-option': "flex-1 py-2 px-4 rounded-md border border-gray-300 bg-white text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue-500",
        'tool-option-active': "flex-1 py-2 px-4 rounded-md border-2 border-brand-blue-500 bg-white text-brand-blue-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue-500"
      },
      size: {
