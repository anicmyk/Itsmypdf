      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
          <div className="text-center mb-6">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-3">
              Your Files Never Leave Your Device
            </h1>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto mb-6 px-4">
              Your files stay on your computer while you merge, split, compress, and convert. Completely free to use.
            </p>

            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-6 px-4">
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white rounded-lg p-6 sm:p-8 shadow-sm min-h-[140px]">
