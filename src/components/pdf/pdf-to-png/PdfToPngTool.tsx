    ...
    const handleConvertToPng = async () => {
        ...
        try {
            ...
            for (let i = 1; i <= totalPages; i++) {
                ...
                zip.file(`page-${pageNumPadded}.png`, base64Data, { base64: true });
            ...
            link.href = url;
            link.download = activeFile.name.replace('.pdf', '-pngs.zip');
            ...
            alert('Failed to convert pages to PNG.');
        } finally {
                        ...
                        <div className="p-5 space-y-6">
                            <div className="bg-brand-blue-50 border border-brand-blue-100 rounded-lg p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-brand-blue-800 text-sm">Convert to PNG</h3>
                                        <p className="text-xs text-brand-blue-700 mt-1 leading-relaxed">
                                            All pages will be converted to high-quality PNG images and downloaded as a ZIP file.
                                        </p>
                                    </div>
                                </div>
                            </div>
